...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "group relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none",
        "focus:bg-accent focus:text-accent-foreground data-[state=highlighted]:bg-accent data-[state=highlighted]:text-accent-foreground",
  ...
  return (
    <Icon
      ...
      className={cn(
        ...
        "group-data-[highlighted]:text-accent-foreground group-focus:text-accent-foreground",
