...
import { ChartAreaIcons } from "./=components/cards-chart";
import { FrequentBought } from "./=components/cards-frequentbought";

export default function SellerDashboard() {

  return (
    <section className="relative min-h-screen min-w-full overflow-hidden space-y-5 mt-18 mx-3">
      <h1 className="text-xl font-bold mb-1 text-[#2E7D32]">Welcome back &#40;Hardcoded&#41;</h1>
